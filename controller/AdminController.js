import { listCampaigns as workflowList, getCampaign, changeStatus, removeCampaign } from "./campaignWorkflow.controller.js";
import { listAllApplications, supportApplicationDecision } from "./applicationWorkflow.controller.js";
...
export const listCampaigns = workflowList("basic");
export const getCampaignById = getCampaign("basic");
export const updateCampaignStatus = changeStatus("basic");
export const deleteCampaign = removeCampaign("basic");
export const listApplications = listAllApplications;
export const updateApplicationStatus = supportApplicationDecision;
